...
import { makeRoleMiddleware } from '../../middlewares/validate-roles'

export const signupRoutes = Router()

signupRoutes.post('/', ...AdaptRouteMiddleware(validator(schemaSignup), makeRoleMiddleware()), AdaptRoute(makeSignupController()))
